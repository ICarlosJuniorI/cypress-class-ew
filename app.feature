Feature: Image Registration
  ...
  Scenario: Submitting an image with valid inputs using enter key
    ...
    When I enter "https://i.pinimg.com/280x280_RS/70/aa/4e/70aa4eb50f683d6f0564208b03df5416.jpg" in the URL field
  ...
  Scenario: Submitting an image and updating the list
    ...
    Then I have entered "https://i.pinimg.com/280x280_RS/70/aa/4e/70aa4eb50f683d6f0564208b03df5416.jpg" in the URL field
